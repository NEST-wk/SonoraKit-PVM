...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class ShaderPass {
      props: { material?: { uniforms: Uniforms }; output?: THREE.WebGLRenderTarget | null; output0?: THREE.WebGLRenderTarget; output1?: THREE.WebGLRenderTarget };
      uniforms?: Uniforms;
      ...
      constructor(props: { material?: { uniforms: Uniforms; vertexShader?: string; fragmentShader?: string }; output?: THREE.WebGLRenderTarget | null; output0?: THREE.WebGLRenderTarget; output1?: THREE.WebGLRenderTarget }) {
        this.props = props || {};
